...
ensureExists('/Users/Elliot/Desktop/ADS/ADS_source/api/reports/4', 0744, function(err) {
    if (err){
    	console.log(err);
...
pObj.addImage ( path.resolve(__dirname, '/Users/Elliot/Desktop/ADS/ADS_source/api/report_generation_assets/company_icon.png' ) );
pObj.addLineBreak ();
pObj.addLineBreak ();
...
var savePath = '/Users/Elliot/Desktop/ADS/ADS_source/api/reports/'+fileNameString;
var out = fs.createWriteStream ( '/Users/Elliot/Desktop/ADS/ADS_source/api/reports/'+fileNameString);
